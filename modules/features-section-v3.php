<?php
vc_map(array(
    "name" 			=> "Features Section v3",
    "category" 		=> 'Templates & Addons',
    "description"	=> "",
    "base" 			=> "tavc_features_section_v3",
    "class" 		=> "",
    "icon" 			=> "tavc_icon",
...
function tavc_features_section_v3_shortcode($atts, $content = null) {
    extract(shortcode_atts(array(
    
        'icon_fa' => 'fa fa-bullseye',
        'title' => '',
        'desc' => '',
        'button' => '',
        'heading_font' => '',
    ...
    $html .= '<div class="feature-block inner-5 center-holder '.$el_class.'">
...
add_shortcode("tavc_features_section_v3", "tavc_features_section_v3_shortcode");