...
vc_map(array(
    ...
    "params" 	=> array(
        array(
            ...
            "param_name" => "image",
            "value" => "",
            "description" => __("perfect size is: 510x398", "tavc")
        ),
        array(
            "type" => "textfield",
...
function tavc_info_section_v2_shortcode($atts, $content = null) {
    ...
    if ($list_items !== ''){
        ...
        foreach ($list_items as $list_item) {
            $list_html .= '<li style="'.$desc_styles.'"><i class="'.$list_item['icon_fa'].'"></i>'.$list_item['list_content'].'</li>';
        }
        $list_html .='</ul>
                    </div>';
    }
    ...
    $html .= '<div class="mg-container '.$el_class.'">
            ...
            <div class="mg-col-md-6 mg-col-sm-12">
                <div class="pl-45-md">
                    <img src="'.$image[0].'" class="rounded-border shadow-primary full-width" alt="img">
                </div>
            </div>
            </div>
            </div>';
...
add_shortcode("tavc_info_section_v2", "tavc_info_section_v2_shortcode");