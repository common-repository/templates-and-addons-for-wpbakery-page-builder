...
vc_map(array(
    ...
    "params" 	=> array(
        array(
            ...
            "param_name" => "image",
            "value" => "",
            "description" => __("perfect size is: 296x289", "tavc")
        ),
        array(
            "type" => "textfield",
        ...
        array(
            ...
            "step"        => 1,
            "unit"        => "px",
            "description" => __("Chose description font size as pixel. Default is 13px", "asvc"),
            "group"       => "Styles"
        ),
        array(
            "type"        => "colorpicker",
...
function tavc_service_v1_shortcode($atts, $content = null) {
    ...
    $html .= '<div class="service-overlay '.$el_class.'">
                    <img src="'.$image[0].'" alt="">
                    <div class="service-overlay-box center-holder" id="tavc_univ_color">
...
add_shortcode("tavc_service_v1", "tavc_service_v1_shortcode");